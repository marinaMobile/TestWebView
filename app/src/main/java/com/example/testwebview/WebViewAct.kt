...
import com.example.testwebview.Cnst.CAMPL1
import com.example.testwebview.Cnst.CAMPL2
import com.example.testwebview.Cnst.CAMPL3
import com.example.testwebview.Cnst.DEEPL1
import com.example.testwebview.Cnst.DEEPL2
import com.example.testwebview.Cnst.DEEPL3
...
class WebViewAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1.settings.userAgentString = "Mozilla/5.0 (Linux; Android " + Build.VERSION.RELEASE +"; "+ Build.MODEL + " Build/" +Build.ID +"; wv) Version/4.0 Chrome/102.0.5005.78 Mobile"
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.example.testwebview"
        ...
        val first = "https://"
        val second = "tracker.infinitum.works/KypTkg"
